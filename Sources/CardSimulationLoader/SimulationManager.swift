...
public protocol SimulationManagerDelegate: class {
    /**
...
public class SimulationManager {
    ...
    public static let defaultVersion = "2.7.9-395"
    ...
    public func createSimulation(
        ...
        return try SimulationManager.loadCardSimulatorDependencies(version: simulatorVersion, outputDirectory: simPath)
                                ...
                                Result {
                                    ...
                                    xmlData.save(to: self.tempFile(for: configFile))
                                            .flatMap { [unowned self] result in
                                                ...
                                                Result {
                                                    try self.manageSimulation(simulator: result.url,
    ...
    public func stop(simulation: SimulationRunnerType, waitUntilDone flag: Bool = true) {
        ...
        self.remove(simulation: simulation)
    }
